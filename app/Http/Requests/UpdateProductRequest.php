...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'price_buy' => 'required|numeric|regex:/^\d+(\.\d{1,2})?$/|digits_between:1,10',
            'price' => 'required|numeric|regex:/^\d+(\.\d{1,2})?$/|digits_between:1,10',
            'qty' => 'required|numeric|between:1,1000',
            'price_sale' => 'nullable|required_with:date_begin,date_end|numeric|regex:/^\d+(\.\d{1,2})?$/|min:1000|lt:price',
