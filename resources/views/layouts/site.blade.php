                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu fs-5">
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom"
                                                        href="./index-KhuyenMai.html">Sách khuyến mãi</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom"
                                                        href="./index-NoiBat.html">Sách nổi bật</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom" href="#">Sách
                                                        kinh tế</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom" href="#">Sách
                                                        kỹ năng</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom" href="#">Tạp
                                                        chí</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom"
                                                        href="#">Truyện tranh</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom" href="#">Sách
                                                        thiếu nhi</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom" href="#">Sách
                                                        thường thức</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 " href="#">Sách văn học</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu fs-5">
                                                ...
                                                <li><a class="dropdown-item py-3 fs-4 border-bottom"
                                                        href="#">Sách
                                                        thường thức</a></li>
                                                <li><a class="dropdown-item py-3 fs-4 " href="#">Sách văn
                                                        học</a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <div id="carouselExampleCaptions" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://images.unsplash.com/photo-1551029506-0807df4e2031?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1334&q=80"
                ...
                <div class="category_product py-5">
                    ...
                    <div class="row product my-5">
                        <div class="col-md-9 col-12 owl-carousel-parent">
                            <div class="row title border-1 border-dark border-bottom mb-5">
                                <div class="col-md-10 col-8  ">
                                    <h2 class="custom-title d-inline-block "><a class="text-decoration-none "
                                            href="index.php?option=product">Light novel</a></h2>
                                </div>
                                <div class="col-md-2 col-4 text-end owl-carousel-parent__btn">
                                    <button class='back-btn '>
                                        <i class="fa-solid fa-chevron-left"></i>
                            ...
                            <div class="large-12 columns">
                                <div class="owl-carousel book_carousel  owl-theme ">
                                            ...
                                            <div class="row g-0 ">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="card-body">
                                                        ...
                                                        <h3 class="card-title product-name mt-0 text-line-2 ">1Harry
                                                            Potter Và Chiếc Cốc Lửa - Tập 4</h3>
                                                        <div class="row item-price ">
                                                            <div class="col-md-6 col-6 ">
                                                                <h3 class="m-0  amount">243.000₫</h3>
                                    ...
                                    <div class="item  p-0 bg-none">
                                        <div class="card ">
                                            <div class="row g-0 ">
                                                <div class="product-wrapper  col-md-12 col-12 item-img">
                                                    <a href="#">
                                                        <img src="{{ asset('image/harry-potter/Bìa_sách_Harry_Potter_phần_4.jpg') }}"
                                                            class="card-img-top img-product img-fluid py-auto"
                                                            alt="...">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="card-body">
                                                        ...
                                                        <h3 class="card-title product-name mt-0 text-line-2 "><a
                                                                href="#">Harry
                                                                Potter Và Chiếc Cốc Lửa - Tập 4</a></h3>
                                                        <div class="row item-price ">
                                                            <div class="col-md-6 col-6 ">
                                                                <h3 class="m-0  amount">243.000₫</h3>
                                                            </div>
                        ...
                        <div class="col-md-3 d-md-block d-none">
                            <div class="col-md-12 col-12 item-img">
                                <a href="./product-detail.html">
                                    <img src="https://demo.wpthemego.com/themes/sw_coruja/wp-content/uploads/2019/07/bn4.jpg"
                                        class="card-img-top img-product_category img-fluid py-auto" alt="...">
                                </a>
                    ...
                    <div class="row product my-5">
                        ...
                        <div class="col-md-9 col-12 my-auto owl-carousel-parent">
                            <div class="row title border-1 border-dark border-bottom mb-5">
                                <div class="col-md-10 col-8  ">
                                    <h2 class="custom-title d-inline-block "><a class="text-decoration-none "
                                            href="index.php?option=product">Khoa học viễn tưởng</a></h2>
                                    ...
                                    <div class="item  p-0 bg-none">
                                        <div class="card product-wrapper ">
                                            <div class="row g-0 ">
                                                <div class="col-md-12 col-12 item-img">
                                                    <a href="./product-detail.html">
                                                        <img src="{{ asset('image/tieu thuyet/noi-khu-rung-cham-toi-nhung-vi-sao-where-the-forest-meets-the-stars.jpg') }}"
                                                            class="card-img-top img-product img-fluid py-auto"
                                                            alt="...">
                                                    </a>
                                                    <div class="product-action">
                                    ...
                                    <div class="item  p-0 bg-none">
                                        <div class="card product-wrapper ">
                                            <div class="row g-0 ">
                                                <div class="col-md-12 col-12 item-img">
                                                    <a href="./product-detail.html">
                                                        <img src="{{ asset('image/tieu thuyet/Chúa Tể Những Chiếc Nhẫn - Nhà Vua Trở Về.jpg') }}"
                                                            class="card-img-top img-product img-fluid py-auto"
                                                            alt="...">
                                                    </a>
                                                    <div class="product-action">
