                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($category->status == 1)
                                            <a class="btn btn-sm btn-success" href="{{ route('category.status', ['category' => $category->id]) }}">
                                                <i class="fas fa-toggle-on"></i>
                                            </a>
                                        @else
                                            <a class="btn btn-sm btn-danger" href="{{ route('category.status', ['category' => $category->id]) }}">
                                        ...
                                        <a href="{{ route('category.delete', ['category' => $category->id]) }}" class="btn btn-sm btn-danger" title="delete">
