                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active border-right border-bottom border-left p-3 "
                                ...
                                @includeIf('backend.product.edit.tab_product_info', ['some' => 'data'])
                            </div>
                            ...
                            <div class="tab-pane fade show  border-right border-bottom border-left p-3 " id="product_sale"
                                ...
                                @includeIf('backend.product.edit.tab_product_sale', ['some' => 'data'])
                            </div>
                            <div class="tab-pane fade show  border-right border-bottom border-left p-3 "
                                id="product_store" role="tabpanel" aria-labelledby="product_store-tab">
                                @includeIf('backend.product.edit.tab_product_store', ['some' => 'data'])
                            </div>
