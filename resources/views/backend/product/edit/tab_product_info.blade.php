                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input name="name" id="name" type="text" class="form-control "
                                        value="{{ old('name', $product->name) }}" placeholder="vd: Tiểu thuyết">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="metakey" id="metakey" cols="10" rows="2" class="form-control "
                                        placeholder="vd: harry potter">{{ old('metakey', $product->metakey) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="2" {{ $product->status == 2 ? 'selected' : '' }}>Chưa xuất
                                            bản
                                        </option>
