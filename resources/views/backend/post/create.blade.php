                            ...
                            <div class="col-md-9">
                                <div class="mb-3">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control "
                                        value="{{ old('title') }}" placeholder="vd: Tiểu thuyết">
                                    @if ($errors->has('title'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="detail" id="detail" cols="10" rows="2" class="form-control "
                                        placeholder="vd: là một thể loại văn xuôi có hư cấu, thông qua nhân vật, hoàn cảnh, sự việc để phản ánh bức tranh xã hội">{{ old('detail') }}</textarea>
